...
$datas = '';
$datas .= 'Заявка "Получить результат"' . "\n";
$datas .= 'Имя: ' . $_POST['name_result'] . "\n";
$datas .= 'Телефон: ' . $_POST['phone_result'] . "\n";
$datas .= 'Кузов: ' . $_POST['kuzov_result'] . "\n";
$datas .= 'Цена: ' . $_POST['price_result'] . "\n";
$datas .= 'Год: ' . $_POST['old_result'] . "\n";
