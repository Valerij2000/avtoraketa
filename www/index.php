...
<!— /Yandex.Metrika counter —>
    ...
    <script src="//code-sb1.jivosite.com/widget/blIZ2iktav" async></script>
  ...
  <!-- slider-->
                    ...
                    <div class="col-md-9 col-lg-5">
                      <div class="embed-responsive embed-responsive-16by9">
                          <div class="embed-responsive-item">
                            <img src="https://i.ytimg.com/vi/vpiA4IGylRk/maxresdefault.jpg" alt="">
                          </div>
                      </div>
                    </div>
                    <div class="col-md-9 col-lg-5 col-xxl-4">
                      <h3>Хотите сравнитить нас с конкурентами ?</h3>
                      <div class="divider divider-default"></div>
                      <p class="text-spacing-sm">Нажмите кнопку ниже, чтобы вставить ссылку на лот аукциона </p>
          ...
          <div class="row row-50 justify-content-sm-center">
            <div class="col-sm-10 col-md-6 col-xl-3">
              <article class="box-minimal-modern">
                ...
                <div class="box-minimal-text">Менеджер ответит на все ваши вопросы о покупке авто из США, расскажет об особенностях процесса и ценообразовании авто из США.Подписания официального договора в нашем офисе или удаленно.</div>
              </article>
            </div>
            <div class="col-sm-10 col-md-6 col-xl-3">
              <article class="box-minimal-modern">
      ...
      <section id="catalog" class="section section-lg text-center bg-gray-lighter">
        ...
        <div class="container-wide">
          <h3>Это примеры автомобилей<br>которые мы можем доставить для Вас</h3>
		  <div class="divider divider-default"></div>
              ...
              <div class="container container-bigger">
                <div class="row row-ten row-50 justify-content-md-center justify-content-xl-between">
                  <div class="col-md-9 col-lg-6">
                    ...
                    <p class="big">Если у Вас остались вопросы или есть желание узнать больше о экономии Вашего бюджета при покупке авто из США,Грузии и других стран, оставьте заявку и мы свяжемся с Вами в ближайшее время.</p>
                    <!-- RD Mailform-->
...
<? require ('code/modal_auction_lot.php'); ?>
